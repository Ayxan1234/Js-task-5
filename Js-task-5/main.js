...
// tasks
// 1) height in 150 den boyuk olanlari filterden isdifade ederek tapin
 
// const getData = ()=>{
//     let newData = users.filter ((users) => users.height > 150)
//     console.log(newData);
...
// 2) funksiya yaradin funksiyani cagiranda parametre ad verin hemin ada gore yuxaridaki 
// arrayden melumatlari tapib ekrana yazsin meselen getName("Addison") Addison a aid objecti logda gorsetsin

// function getName (){
//     users.map ((person) =>{
//     if(person.firstName == "Addison"){
//         console.log(person);
...
// 3) reduce dan isdifade ederek butun yaslari toplayib ortaq yasi tapin

// const firstyear =()=>{
//     let firstyear = users.reduce ((total, ages) => total+= ages.age, 0)
...
// 4) sortdan isdifade ederek azalandan artan yasa qeder arraydeki elementleri sirallayan func yazin

// let numbers = [28,35,42,45,30,22,38,27,33,31,29,24,40,36,32,25,37,31,38,34,26,36,27,35,41,29,38,32];
// console.log(numbers.sort((a,b) => a-b));


// 5) map den isdifade ederek title Web Developer olanlari secen func yazib loga verin

// function webDeveloper () {
//     users.map ((person) => {
//         if (person.company.title == "Web Developer") {
//             console.log(person);
